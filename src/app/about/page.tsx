...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    keywords: [
      "About Denise childminder Gillingham",
      "childminder Gillingham",
      "registered childminder Kent",
      "experienced childcare Gillingham",
      "Ofsted registered childminder",
      "qualified childcare provider Gillingham",
      "home daycare Gillingham",
      "childcare qualifications Kent",
      "NVQ childcare Gillingham",
      "Dees Curious Minds",
    ],
    alternates: {
