      ...
      <div className="max-w-4xl mx-auto space-y-6 relative">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight leading-tight font-poppins">
            Looking for a nurturing and <br className="hidden sm:inline" />
            inspiring childcare environment?
          </h2>
          <p className="text-xs sm:text-sm md:text-base text-slate-300 font-inter max-w-xl mx-auto leading-relaxed">
            Let's discuss how we can support your child's learning journey. Schedule a friendly home visit to meet Denise and tour our playroom!
          </p>
        </motion.div>
